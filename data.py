...
# # %% result
# folder = '/home/pwuaj/hkust/DR/grad2'
# thresholds = {'384':0.558, '448':0.61, 'resnet': 0.08, '576':0.63, 'dense':0.7, 'inception':0.39, 'Phoom':0.69, 'hp': 0.827}
# results = []
# for model in [ 'resnet']:
#     result = []
...
# test.to_csv('/home/pwuaj/hkust/DR/grad.csv')
