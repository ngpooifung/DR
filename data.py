...
# thresholds = {'384':0.558, '448':0.61, '576':0.62, 'resnet': 0.63, 'dense':0.7, 'inception':0.39, 'Phoom':0.69, 'hp': 0.055}
# results = []
# for model in ['resnet']:
#     result = []
...
# test.to_csv('/home/pwuaj/hkust/DR/VTDR01.csv')
