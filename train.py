...
function_names = ['main', 'eval', 'Clip', 'Clipfulltune', 'Cliplayertune', 'Cliptransfer']
...
def Cliptune():
    ...
    if args.process == 'Cliplayertune':
        for name, param in model.named_parameters():
            ...
            if name not in ['ffn.0.weight', 'ffn.0.bias', 'ffn.2.weight', 'ffn.2.bias', 'visual.proj', 'text_projection']:
